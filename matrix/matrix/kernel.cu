...
int main(int argc, char *argv[])
{
	...
	int number_original_points = 512 * 512;
	int number_sampling_points = 1024;

	float *original_points = new [ number_original_points ];
	float *sampling_points = new [ number_sampling_points ];
